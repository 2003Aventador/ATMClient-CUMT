...
public class InputOldPassword extends JFrame implements MouseListener {
    ...
    private void initView() {
        ...
        //中文提示  后续可以添加英文提示
        JLabel sinText = new JLabel("<HTML>请  输  入  原  密  码</HTML>", SwingConstants.CENTER);
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (source == confirm) {
            ...
            try {
                ...
                System.out.println("输入原密码界面没有调用生成虚假数据的方法导致user为空");
            }
